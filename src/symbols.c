...
static const struct {
	...
	/*  >  30  */	{ "MV", "Car" },
	/*  ?  31  */	{ "MW", "File Server" },
	/*  @  32  */	{ "MX", "Hurricane Future Prediction" },
	/*  A  33  */	{ "PA", "Aid Station" },
	/*  B  34  */	{ "PB", "BBS or PBBS" },
	/*  C  35  */	{ "PC", "Canoe" },
	/*  D  36  */	{ "PD", "" },
	/*  E  37  */	{ "PE", "Eyeball (events, etc.)" },
	/*  F  38  */	{ "PF", "Farm Vehicle (Tractor)" },
	/*  G  39  */	{ "PG", "Grid Square (6 digit)" },
	/*  H  40  */	{ "PH", "Hotel (blue bed symbol)" },
	/*  I  41  */	{ "PI", "TCP/IP on air network stn" },
	/*  J  42  */	{ "PJ", "" },
	/*  K  43  */	{ "PK", "School" },
	/*  L  44  */	{ "PL", "PC user" },
	/*  M  45  */	{ "PM", "MacAPRS" },
	...
	/*  P  48  */	{ "PP", "Police" },
	/*  Q  49  */	{ "PQ", "TBD" },
	/*  R  50  */	{ "PR", "Recreational Vehicle" },
	/*  S  51  */	{ "PS", "Space Shuttle" },
	/*  T  52  */	{ "PT", "SSTV" },
	/*  U  53  */	{ "PU", "Bus" },
	/*  V  54  */	{ "PV", "Amateur TV" },
	/*  W  55  */	{ "PW", "National Weather Service Site" },
	/*  X  56  */	{ "PX", "Helicopter" },
	/*  Y  57  */	{ "PY", "Yacht (sail)" },
	/*  Z  58  */	{ "PZ", "WinAPRS" },
	/*  [  59  */	{ "HS", "Jogger, Human/Person (HT)" },
	/*  \  60  */	{ "HT", "Triangle (DF station)" },
	/*  ]  61  */	{ "HU", "Mail/Post Office" },
	/*  ^  62  */	{ "HV", "Large Aircraft" },
	/*  _  63  */	{ "HW", "Weather Station (blue)" },
	/*  `  64  */	{ "HX", "Dish Antenna" },
	/*  a  65  */	{ "LA", "Ambulance" },
	/*  b  66  */	{ "LB", "Bike / Bicycle" },
	...
	/*  o  79  */	{ "LO", "Emergency Operations Center (EOC)" },
	/*  p  80  */	{ "LP", "Rover (puppy, or dog)" },
	/*  q  81  */	{ "LQ", "Grid Square shown above 128 m" },
	/*  r  82  */	{ "LR", "Repeater" },
	/*  s  83  */	{ "LS", "Ship (power boat)" },
	/*  t  84  */	{ "LT", "Truck Stop" },
...
static const struct {
	...
	/*  %  05  */	{ "OF", "Power Plant" },
	/*  &  06  */	{ "OG", "I=IGate R=RX T=1hopTX 2=2hopTX" },
	/*  '  07  */	{ "OH", "Crash (& Incident sites)" },
	/*  (  08  */	{ "OI", "Cloudy" },
	...
	/*  >  30  */	{ "NV", "Cars & Vehicles" },
	/*  ?  31  */	{ "NW", "Information Kiosk  (Blue box with ?)" },
	/*  @  32  */	{ "NX", "Hurricane/Tropical-Storm" },
	/*  A  33  */	{ "AA", "Box: DTMF, RFID, XO" },
	/*  B  34  */	{ "AB", "Blowing Snow" },
	/*  C  35  */	{ "AC", "Coast Guard" },
	/*  D  36  */	{ "AD", "Drizzle" },
	/*  E  37  */	{ "AE", "Smoke (& other vis codes)" },
	/*  F  38  */	{ "AF", "Freezng Rain" },
	/*  G  39  */	{ "AG", "Snow Shower" },
	/*  H  40  */	{ "AH", "Haze" },
	/*  I  41  */	{ "AI", "Rain Shower" },
	/*  J  42  */	{ "AJ", "Lightning" },
	...
	/*  _  63  */	{ "DW", "WX Station with digi (green)" },
	/*  `  64  */	{ "DX", "Rain" },
	/*  a  65  */	{ "SA", "ARRL, ARES, WinLINK, Dstar, LoRa, etc" },
	/*  b  66  */	{ "SB", "Blowing Dust/Sand" },
	/*  c  67  */	{ "SC", "CD triangle RACES/SATERN/etc." },
	/*  d  68  */	{ "SD", "DX spot (from callsign prefix)" },
	/*  e  69  */	{ "SE", "Sleet" },
	/*  f  70  */	{ "SF", "Funnel Cloud" },
	/*  g  71  */	{ "SG", "Gale Flags" },
	/*  h  72  */	{ "SH", "Store or Hamfest" },
	/*  i  73  */	{ "SI", "BOX or points of Interest" },
	/*  j  74  */	{ "SJ", "Work Zone (Steam Shovel)" },
	/*  k  75  */	{ "SK", "Special Vehicle SUV,ATV,4x4" },
	/*  l  76  */	{ "SL", "Areas Symbols (box, circle, etc.)" },
	/*  m  77  */	{ "SM", "Value Sign (3 digit display)" },
	/*  n  78  */	{ "SN", "Triangle" },
	/*  o  79  */	{ "SO", "Small Circle" },
	/*  p  80  */	{ "SP", "Partly Cloudy" },
	/*  q  81  */	{ "SQ", "" },
	/*  r  82  */	{ "SR", "Restrooms" },
	/*  s  83  */	{ "SS", "Ship/Boat (top view)" },
	/*  t  84  */	{ "ST", "Tornado" },
	/*  u  85  */	{ "SU", "Truck" },
	/*  v  86  */	{ "SV", "Van" },
	/*  w  87  */	{ "SW", "Flooding (Avalanches/Slides)" },
	/*  x  88  */	{ "SX", "Wreck or Obstruction" },
	/*  y  89  */	{ "SY", "Skywarn" },
...
void symbols_list (void) 
{
	...
	dw_printf ("\tThese are not widely adopted.\n");
	dw_printf ("\n");
	...
	dw_printf ("\n");
	dw_printf ("Symbol Tables with icons: https://github.com/wb2osz/aprsspec/raw/main/APRS-Symbols.pdf\n");
 ...
 *
 *			This is obsolete.  It was a short lived hack for the first
 *			trackers that did not have enough memory to parse the
 *			GPS NMEA semtemce amd construct a Position Report.
 *			They sent the raw GPS sentence and used the AX.25 destination
 *			field to convey a symbol.
 *
 *		If all else fails,
 *
 *		- SSID of the source address.
 *
 *			This is obsolete and produces confusing results.
 *
 *
 *------------------------------------------------------------------*/
 ...
 *
 * This is now obsolete but the code is still active because
